...
# Trang chờ xét duyệt
$total_waitting = db_num_rows("SELECT* FROM  `tbl_pages` Where `page_status`= 'Waitting...'");
# Trang đã bị xóa
        ...
        <div id="content" class="fl-right">
            <div class="section" id="detail-page">
                <div class="section-detail">
                    ...
                    <form method="POST" action="?mod=pages&controller=index&action=apply_pages&page_id=<?php echo $page_num;?>">
                        <div class="actions">
            ...
            <div class="section" id="paging-wp">
                <div class="section-detail clearfix">
                    ...
                    <ul id="list-paging-pages" class="fl-right">
                        <?php
                            echo get_pagging($num_page, $page_num, "?mod=pages&controller=index&action=index");
                        ?>
                    </ul>
                </div>
            </div>
