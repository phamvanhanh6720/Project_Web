...
$total_waitting = db_num_rows("SELECT* FROM  `tbl_sliders` Where `slider_status`= 'Waitting...'");
# Sản phẩm đã bị xóa
        ...
        <div id="content" class="fl-right">
            ...
            <div class="section" id="detail-page">
                <div class="section-detail">
                    ...
                    <form method="POST" action="?mod=slider&controller=index&action=apply_sliders&page_id=<?php echo $page_num;?>">
                        <div class="actions">
            ...
            <div class="section" id="paging-wp">
                <div class="section-detail clearfix">
                    ...
                    <ul id="list-paging" class="fl-right">
                        <?php
                            echo get_pagging($num_page, $page_num, "?mod=slider&controller=index&action=index");
                        ?>
                    </ul>
                </div>
            </div>
