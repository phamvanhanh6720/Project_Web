                ...
                <div id="list-menu" class="fl-left">
                    ...
                    <form  method="POST" action="?mod=menu&action=add_menu">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="url_static" id="url-static" value="<?php echo set_value('url_static')?>">
                            ...
                            <?php if(!empty($list_product_cat_all)){
                                ...
                                <select name="product_id">
                                    ...
                                    <?php foreach($list_product_cat_all as $prodcut_cat){
                                        ?>
                                        <option <?php if(!empty($_POST['product_id']) && $_POST['product_id'] == $prodcut_cat['title']) echo "selected='selected'"; ?> value="<?php echo $prodcut_cat['title']?>"><?php echo str_repeat('--', $prodcut_cat['level']).' '.$prodcut_cat['title']?></option>
                                    <?php
                                    }
                                    ?>
                                </select> 
                        ...
                        <div class="form-group clearfix">
                            ...
                            <select name="post_id">
                                ...
                                <?php foreach($list_post_cat_all as $post_cat){
                                    ?>
                                    <option <?php if(!empty($_POST['post_id']) && $_POST['post_id'] == $post_cat['title']) echo "selected='selected'"; ?> value="<?php echo $post_cat['title']?>"><?php echo str_repeat('--', $post_cat['level']).' '.$post_cat['title']?></option>
                                <?php
                                }
                                ?>
                            </select>
                        ...
                        <br>
                        <div class="form-group">
                            <button type="submit" name="btn-add-menu" id="btn-save-list">THÊM MENU</button>
                        </div>
                    </form>
                </div>
